...
Key features include a mechanism to indicate identity assurance levels and guidance on minimizing payload size for QR code embedding. The standard aligns with the SMART Health Cards specification and privacy regulations like HIPAA and GDPR.
